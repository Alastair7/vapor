...
module.exports = {
	...
	async execute(interaction) {
		...
		console.log(`Searching AutoroleMessage ${messageId} within channel ${channelId}`);
		const existingMessage = await AutoroleMessage.findOne({ channelId: channelId, messageId: messageId });
		...
		else if (existingMessage != null && !existingMessage.emojiMap.has(emojiName)) {
